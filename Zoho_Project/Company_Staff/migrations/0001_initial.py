    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Adjusting_date', models.DateField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Register_Login.companydetails')),
                ('inventory_adjustment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Company_Staff.inventory_adjustment')),
                ('login_details', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Register_Login.logindetails')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('New_quantity_inhand', models.IntegerField(blank=True, default=0, null=True)),
                ('Quantity_adjusted', models.IntegerField(blank=True, default=0, null=True)),
                ('Current_value', models.IntegerField(blank=True, default=0, null=True)),
                ('Changed_value', models.IntegerField(blank=True, default=0, null=True)),
                ('Adjusted_value', models.IntegerField(blank=True, default=0, null=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Register_Login.companydetails')),
                ('inventory_adjustment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Company_Staff.inventory_adjustment')),
                ('login_details', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Register_Login.logindetails')),
